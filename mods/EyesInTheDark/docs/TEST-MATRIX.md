...
| G13 | Trigger Eyes and vanilla GFT Wyrd messages, then switch Purple Wyrdness to Native Orange live | Every Wyrd atmosphere line uses the configurable Purple group first and Orange group after the switch; priority, duration, and Wyrd icon stay unchanged | Pending |

...
$guardAwarenessSource = Get-Content -LiteralPath (
...
$allEyesText = $pluginSource + $catalogSource + $runtimeSource + $guardAwarenessSource + $ambientDirectorSource + $ambientRuntimeSource + $worldTimescaleSource + $meterSource `

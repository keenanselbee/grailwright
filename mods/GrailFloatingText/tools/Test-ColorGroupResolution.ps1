...
$requiredGroups = @("Red", "Gold", "Blue", "Cyan", "Green", "Necrotic", "Purple", "Pink", "Orange", "Pale", "Gray", "White", "Default")
...
if (-not [regex]::IsMatch($bindings, '"Blue"\s*,\s*"#8496FF"')) {
    throw "Blue must bind with the authored #8496FF default."
}

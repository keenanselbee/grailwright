...
| 5 | Wailcap | Sea Creature / Animal | `SeaFlesh` | Confirmed: `Poison 25%`; Cold through the Sea family when native is neutral | Electric, slash, and pierce through SeaFlesh | Exact correction prevents its appearance from adding broad Flora rules. |
| 5 | Viridian Wailcap | Sea Creature / Animal | `SeaFlesh` | Follows the Wailcap Sea identity when its runtime name is exposed | Electric, slash, and pierce through SeaFlesh | Exact Wailcap matching covers the named variant. |
| 5 | Swarm Of Viridian Wailcaps | Sea Creature / Animal | `SeaFlesh` plus swarm delivery rule | Sea-family Cold and individual arrow resistance | Electric, slash, and non-arrow area attacks | Keep mild because swarm enemies can become tedious. |
...
|---:|---|---|---|---|
| 1 | Bone undead | Implemented; validate in game | `Skeleton`, `Bone`, `Abandoned Warrior`, `Skeleton Mage`, `Abstract:Skeleton`, `HitBones` | Current rules resist blood/bleed, Cold, slash/pierce, and generic physical; blunt is a small Steel and Bone weakness only when vanilla has not already handled it. Confirm target classification, Chill independence, and vanilla subtype skips. |
| 1 | Drowned zombies | Implemented; validate in game | `Drowner`, `Drowned`, `Drowned Knight`, `Ghost Crew`, `Scourge`, `Abstract:Zombie` plus water/dead naming | Current rules resist blood/bleed and mildly resist pierce while leaving slash neutral; Electric/blunt are the shared weaknesses. Confirm that vanilla Drowner `Fire 50%` remains preserved. |
| 1 | Constructs and animated armor | Implemented; validate in game | `Golem`, `Construct`, `Sentinel`, `Forgeborn`, `Cairnguard`, `Lost Knight`, `Tibby`, `Bottomless`, `Brimshade`, `HitStone` | Current rules resist blood/bleed/poison, Cold, slash/pierce, and generic physical; blunt is a Steel and Bone weakness. Confirm template-specific elemental exceptions still win through vanilla skip logic and Chill remains independent. |
| 1 | Wyrd | Implemented; validate in game | `Wyrd`, `Wyrdspawn`, `Wyrdspirit`, `Wyrdslime`, `Wyrdheir`, `Abstract:WyrdnessBound` | Neutral Wyrd targets remain neutral to Wyrdness; authored native and exact reactions still win. Confirm pure Wyrd casting remains viable without erasing archetype-specific resistance. |
| 2 | Red Death infected | Implemented; validate in game | `Red Death`, `Infected`, `Abstract:Zombie`, `Abstract:Bloody` | Current rules resist Poison, add Fire weakness only when vanilla has not already handled Fire, and add mild slash/pierce weaknesses while leaving blunt neutral. Confirm Red Death vanilla Poison/Fire multipliers are skipped rather than duplicated. |
| 2 | Flesh undead | Implemented cautiously; validate in game | `Zombie`, `Undead`, `Bloody`, `Frostbitten Warrior`, `Plaguewraith` | Current rules mildly resist blood/bleed/poison and pierce, leave slash neutral, and add modest Fire/blunt weakness. Wights are corrected to Flora; confirm DrownedZombie and InfectedFlesh terms refine broad FleshUndead metadata when present. |
...
| 3 | Flora and fungus | Implemented; validate in game | `Dryad`, `Frond`, `Tree`, `Stump`, `Fleshtree`, exact Wights | Current rules resist Poison/Bleed/Pierce and add Fire/Slash weakness. Wailcaps are corrected to SeaFlesh instead of receiving broad Flora rules. |

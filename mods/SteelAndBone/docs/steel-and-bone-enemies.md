...
| 2 | Flesh undead | Implemented cautiously; validate in game | `Zombie`, `Undead`, `Wight`, `Bloody`, `Frostbitten Warrior`, `Plaguewraith` | Current rules mildly resist blood/bleed/poison and pierce, leave slash neutral, and add modest Fire/blunt weakness. Confirm DrownedZombie and InfectedFlesh terms refine broad FleshUndead metadata when present. |

...
Assert-Contract ($difficultySource.Contains('NativePotionPoisoningDecayPerSecond = 10.0f') -and $difficultySource.Contains('* NativePotionPoisoningDecayPerSecond')) "Class buildup does not retain native 10-per-second decay."
...
Assert-Contract ($nexusFull.Contains("Its material system gives bone, flesh, stone, spirit, armor, and other identities distinct reactions")) "Nexus description does not lead with material combat."
...
Assert-Contract ($nexusFull.Contains("Potion Poisoning per class") -and $nexusFull.Contains("| 60") -and $nexusFull.Contains("| 70")) "Nexus preset table does not document class-based Potion Poisoning buildup."

...
$sourceContracts = @(
    ...
    [pscustomobject]@{
        ...
        Restore = 'RestorePreservedSettings();'
        Save = 'Config.Save();'
        Tokens = @('ProtectBonfireLights', 'BuiltInExcludedLightPathFragments', 'AdditionalExcludedLightPathFragments', 'VerboseExclusionLogging', 'RespectExternalPlayerLightOwnership', 'ExcludeHeroLight', 'ExcludeWyrdSightLights', 'ExcludeSummonLights', 'ExcludeInterfacePreviewLights', 'ExcludeLockpickingLights', 'ExcludePlacedBonfireLights', 'UseSafeSelectionController', 'MaximumUpgradedLights', 'MaximumDistanceMeters', 'MaximumShadowMapFaces', 'SuppressAddedVolumetricShadows', 'HysteresisMeters', 'SelectionRetentionMeters', 'PreferViewRelevantLights', 'ScreenCenterPriorityMeters', 'SelectionRefreshSeconds', 'ViewExitDelaySeconds', 'OffscreenReserveLights', 'MaximumSelectionSwapsPerRefresh', 'ShadowHandoffSeconds', 'InitialFillBatchSize', 'InteriorPerformanceEnabled', 'InteriorMaximumUpgradedLights', 'InteriorMaximumDistanceMeters', 'InteriorMaximumShadowMapFaces', 'InteriorPromotedShadowResolution', 'ImproveDawnDuskShadows', 'ShadowBlendMinutes', 'NormalizeForEyesInTheDark', 'EyesBlendSecondsPerSide', 'ProtectShadowAtlas', 'PromotedShadowResolution', 'CombatPerformanceEnabled', 'OutdoorCombatOnly', 'CombatReduceAtlasResolution', 'CombatShadowResolution', 'CombatLimitLightBudget', 'CombatMaximumUpgradedLights', 'CombatLimitDistance', 'CombatMaximumDistanceMeters', 'Diagnostics')
    },
    [pscustomobject]@{
